...
var require = {
	...
	paths: {
		...
		DataTables: ASSETS_BASEURL + "/js/DataTables/media/js/jquery.dataTables.min",
		jqForm: ASSETS_BASEURL + "/js/jquery.form"
	},
	...
	packages: [
		...
		{
		  "name": "SASIRunner",
		  "location": CONTEXT_BASE + "/static/js/SASIRunner/src"
		},
        ...
        {
            "name": "TableSelect",
            "location": ASSETS_BASEURL + "/js/table_select/src"
        },

        {
            "name": "TaskStatus",
            "location": ASSETS_BASEURL + "/js/task_status/src"
        }
	]
